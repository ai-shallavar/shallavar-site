...
const features = [
     { icon: Palette, title: "User Research", desc: "Deep understanding of your target audience through interviews, surveys, and competitive analysis." },
     { icon: Palette, title: "Visual Design", desc: "Stunning interfaces with consistent design systems, typography, color theory, and brand alignment." },
     { icon: Palette, title: "Usability Testing", desc: "Real user testing sessions to identify friction points and optimize conversion flows." },
     { icon: Palette, title: "Design Systems", desc: "Scalable component libraries and style guides that ensure consistency across all touchpoints." },
     { icon: Palette, title: "UX Strategy", desc: "Data-driven design decisions aligned with business goals and user needs." },
