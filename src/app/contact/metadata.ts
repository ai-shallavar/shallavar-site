...
export const metadata: Metadata = {
  ...
  keywords: [
        ...
        "contact IT company Bangalore",
        "web development Banashankari",
        "app development JP Nagar",
        "IT services Whitefield Bangalore",
        "software company MG Road Bangalore",
        "web design Majestic Bangalore",
        "app developers Hebbala",
        "tech startup South Bangalore",
        "website design Bangalore contact",
       ],
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    ...
    images: [{
       ...
       width: 1200,
       height: 630,
       alt: "Contact Shallavar Technologies — Web & Mobile App Development Company Bangalore",
       type: "image/png",
       }],
      },
  twitter: {
  ...
  alternates: {
    canonical: "https://shallavar.com/contact",
      },
};